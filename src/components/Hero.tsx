      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full grid gap-12 items-center z-10 relative pt-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <button onClick={() => setIsModalOpen(true)} className="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-base px-8 py-4 transition-all shadow-lg flex items-center justify-center gap-2 group shadow-blue-600/20 tracking-wide transition-all shadow-[0_0_15px_rgba(255,255,255,0.05)] hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] backdrop-blur-sm">
              Let's Discuss Your Project <ArrowRight size={18} className="group-hover:translate-x-2 transition-transform" />
            </button>
