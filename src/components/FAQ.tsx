...
export const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-24 relative overflow-hidden bg-[#0A0F1E] dark:bg-slate-900/50 transition-colors duration-500 ">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            <MessageCircleQuestion className="w-6 h-6 md:w-8 md:h-8 text-blue-600" />
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className={`font-semibold text-lg transition-colors ${openIndex === index
