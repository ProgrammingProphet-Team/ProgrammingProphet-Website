...
export const Roadmap = () => {
  return (
    <section className="py-24 px-6 md:px-8 lg:px-12 max-w-[1400px] mx-auto ">
      ...
      <div className="relative grid md:grid-cols-7 gap-2">
        {/* Connecting Line */}
        ...
        {ROADMAP.map((item, i) => (
          <motion.div
            ...
            className="relative group interactive z-10"
          >
            {/* Status Indicator */}
            <div className="  w-12 h-12 rounded-full flex items-center justify-center mb-6  border bg-slate-50 dark:bg-slate-800 text-slate-800 border-slate-400 dark:border-slate-700">
              {item.icon}
            </div>

            <div className=" p-6  h-[210px] bg-slate-100 transform transition-all duration-300 group-hover:-translate-y-2 hover:shadow-xl dark:border-slate-700/50 relative overflow-hidden">
