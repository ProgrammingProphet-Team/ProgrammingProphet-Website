...
export const ProjectDetails = () => {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-6 lg:px-8 max-w-7xl mx-auto font-sans relative">
      
      {/* Decorative Background */}
      <div className="absolute top-40 left-0 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="absolute top-96 right-0 w-[400px] h-[400px] bg-cyan-600/10 rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="px-4 py-1.5 rounded-full bg-blue-600 text-white text-xs font-bold uppercase tracking-widest shadow-[0_0_15px_rgba(37,99,235,0.5)]">
              Live
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm text-slate-500 font-medium">
            <div className="flex items-center gap-2"><Calendar size={16} /> 2024</div>
            <div className="flex items-center gap-2"><Users size={16} /> 8 developers</div>
        ...
        >
          <a href="#" className="flex items-center gap-2 px-6 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold transition-colors shadow-[0_0_20px_rgba(37,99,235,0.4)]">
            <Globe size={18} /> Live Demo
          </a>
          <a href="#" className="flex items-center gap-2 px-6 py-3 rounded-lg border border-slate-700 hover:border-slate-500 text-white hover:bg-white/5 font-bold transition-all glass">
      ...
      <div className="grid lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          >
            {/* Big Active Image */}
            <div className="w-full h-[400px] md:h-[500px] rounded-[2rem] overflow-hidden glass p-1">
              <img 
            ...
            <div className="grid grid-cols-5 gap-4">
              {galleryImages.map((img, i) => (
                <button 
                  ...
                  className={`relative h-20 md:h-28 rounded-2xl overflow-hidden glass p-1 transition-all ${activeImageIndex === i ? 'ring-2 ring-blue-500 scale-105 shadow-[0_0_20px_rgba(37,99,235,0.4)]' : 'opacity-60 hover:opacity-100'}`}
                >
                  <img src={img} alt={`Thumbnail ${i}`} className="w-full h-full object-cover rounded-[1.1rem]" />
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-8">
              {[
                ...
                { label: "500+ concurrent enterprise users supported", icon: Users }
              ].map((stat, i) => (
                <div key={i} className="glass p-6 rounded-2xl flex items-center gap-5 border border-blue-500/20 hover:border-blue-400/50 transition-colors">
                  <div className="text-blue-400 h-10 w-10 flex items-center justify-center bg-blue-500/10 rounded-xl">
                    <stat.icon size={22} />
                  </div>
            ...
            {/* Testimonial Block */}
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 sm:p-10 shadow-[0_10px_40px_rgba(37,99,235,0.4)] relative overflow-hidden">
               ...
               <div className="flex items-center gap-4 relative z-10">
                 ...
                 <div>
                   ...
                   <p className="text-blue-200 text-sm">CTO, Fortune 500 Inc.</p>
                 </div>
               </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <motion.div 
            ...
            className="glass-panel p-8 rounded-[2rem] border border-slate-700/50 hover:border-slate-600/50 transition-colors"
          >
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {project.tech.concat(['AWS', 'PostgreSQL', 'Redis', 'Docker', 'Kubernetes']).slice(0,8).map(tech => (
                <span key={tech} className="px-4 py-2 text-xs font-bold text-blue-300 bg-blue-900/40 border border-blue-500/30 rounded-full">
                  {tech}
                </span>
              ))}
            </div>
