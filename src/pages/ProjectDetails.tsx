  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#001d3d] via-[#001d3d]  to-[#f1f2f2] text-white font-sans relative">
      <div className="lg:pt-32 pt-24 lg:pb-24 pb-14 px-6 lg:px-8 max-w-7xl mx-auto relative">
        ...
        {/* Hero Section */}
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 lg:mb-12">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="max-w-3xl"
          >
            <div className="flex items-center gap-4 lg:mb-4 mb-2">
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 lg:space-y-12 space-y-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl  lg:text-2xl font-bold text-white lg:mb-4 mb-2">Project Overview</h3>
              <p className="text-slate-300 lg:text-lg text-sm leading-relaxed lg:mb-6 mb-4">
              ...
              <p className="text-slate-300 lg:text-lg text-sm leading-relaxed">
          ...
          <div className="space-y-6 ">
            ...
            <motion.div
              ...
              className="bg-slate-900/50 backdrop-blur-md lg:p-8 p-6 rounded-none border border-slate-800 hover:border-slate-700 transition-colors"
            >
            ...
            <motion.div
              ...
              className="bg-slate-900/50 backdrop-blur-md lg:p-8 p-6 rounded-none border border-slate-800 hover:border-slate-700 transition-colors"
            >
              <h3 className="text-xl font-bold text-white lg:mb-6 mb-4 border-b border-slate-800 pb-4 flex items-center gap-2">
